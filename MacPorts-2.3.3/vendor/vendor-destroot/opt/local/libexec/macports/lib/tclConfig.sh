...
# installed.
TCL_PREFIX='/opt/local/libexec/macports'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/local/libexec/macports'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/jennysteffens/swift-t/MacPorts-2.3.3/vendor/tcl8.5.15/unix -ltcl8.5'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/local/libexec/macports/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/local/libexec/macports/include'
...
# compiled.
TCL_SRC_DIR='/Users/jennysteffens/swift-t/MacPorts-2.3.3/vendor/tcl8.5.15'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/jennysteffens/swift-t/MacPorts-2.3.3/vendor/tcl8.5.15/unix -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/local/libexec/macports/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/jennysteffens/swift-t/MacPorts-2.3.3/vendor/tcl8.5.15/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/local/libexec/macports/lib/libtclstub8.5.a'
