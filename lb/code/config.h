...
/* ExM c-utils location */
#define C_UTILS_LOCATION /tmp/exm-install/c-utils
...
#define PACKAGE_NAME "XLB"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "XLB 0.6.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xlb"
