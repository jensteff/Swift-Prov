...
namespace eval turbine {
  ...
  proc exec_external { cmd kwopts args } {
    ...
    prov_insert ApplicationExecution applicationExecutionId,tries,startTime,try_duration,total_duration,command,stdios,arguments,site,notes $app_hash,$tries,$start,$duration,$total_duration,$cmd,$stdios,$args,$site,$notes [get_db_ptr [adlb::rank]] 
    #prov_insert ApplicationFunctionCall * "$start,$total_duration,0,$cmd" [get_db_ptr [adlb::rank]]
  }
